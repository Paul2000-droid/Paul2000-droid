...
function TimeTillNextYear()
{
	...
	let numSecsSinceYrStarted = Math.ceil(numSecsInYr - distance);
	...
	timetillnextyear.innerHTML = timetillnextyear.innerHTML + "<p>" + CommaFormat(Math.floor(distance)) + " seconds until " + (yr + 1) + ".</p>";
